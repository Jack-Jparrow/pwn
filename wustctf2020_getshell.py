'''
@Author       : 白银
@Date         : 2023-05-02 09:37:04
@LastEditors  : 白银
@LastEditTime : 2023-05-02 09:46:43
@FilePath     : /pwn/wustctf2020_getshell.py
@Description  : https://buuoj.cn/challenges#wustctf2020_getshell
@Attention    : 
...
pwnfile = './wustctf2020_getshell'  # pwnfile， str，二进制文件
...
if if_remote == 1:
    ...
    io = remote("node4.buuoj.cn", 28978)
